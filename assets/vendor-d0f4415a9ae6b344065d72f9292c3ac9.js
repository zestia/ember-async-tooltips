...
async function n(e,t={}){return await i(),Promise.all(e.getAnimations({subtree:t.subtree}).filter((e=>t.transitionProperty?e.transitionProperty===t.transitionProperty:!t.animationName||e.animationName===t.animationName)).map((e=>e.finished.catch((()=>{})))))}function i(){return new Promise(window.requestAnimationFrame)}r.r(t),r.d(t,"waitForAnimation",(function(){return n})),r.d(t,"waitForFrame",(function(){return i}))},function(e,t,r){"use strict"
