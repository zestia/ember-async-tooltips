...
n=u}else n=_e(s)?s:o.component(s,l)
...
e.default=r})),define("@zestia/ember-async-tooltips/components/tooltipper",["exports","@glimmer/component","@zestia/position-utils","@ember/test-waiters","@zestia/animation-utils","@zestia/ember-async-tooltips/utils/auto-position"],(function(e,t,r,n,i,a){"use strict"
var s,o,l,u,c,d,h,p,f,m,v,g,b,y,_,E,w,O,T,R,C,P,S,k,A,x,M,N,I,j
...
this.args.stickyID&&this._scheduleResetSticky(),null===(e=(t=this.args).onHideTooltip)||void 0===e||e.call(t)}async _waitForAnimation(){this.tooltipAnimates&&await(0,i.waitForAnimation)(this.tooltipElement)}_attemptDestroyTooltip(){this.shouldShowTooltip||this._destroyTooltip()}_destroyTooltip(){this.shouldRenderTooltip=!1}_setupReferenceElement(){this._teardownReferenceElement(),this.referenceElement=this.args.referenceElement??this.tooltipperElement,this.shouldUseMouseEvents&&this._startListening()}_teardownReferenceElement(){this.referenceElement&&(this._stopListening(),this.referenceElement=null)}_getReferencePosition(){return(0,r.getPosition)(this.referenceElement,window,this.columns,this.rows)}_computeCoords(e){return(0,r.getCoords)(e,this.tooltipElement,this.referenceElement)}_decideTooltipPosition(e){const{position:t}=this.args
return"string"==typeof t?t:"function"==typeof t?t(e):(0,a.default)(e)}_positionTooltip(){if(!this.tooltipElement||!this.referenceElement)return
const e=this._getReferencePosition(),t=this._decideTooltipPosition(e)
this.tooltipCoords=this._computeCoords(t),this.tooltipPosition=t}},S=F(P.prototype,"tooltipService",[s],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),k=F(P.prototype,"isLoading",[o],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),A=F(P.prototype,"loadedData",[l],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),x=F(P.prototype,"loadError",[u],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),M=F(P.prototype,"shouldRenderTooltip",[c],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),N=F(P.prototype,"shouldShowTooltip",[d],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),I=F(P.prototype,"tooltipCoords",[h],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return[0,0]}}),j=F(P.prototype,"tooltipPosition",[p],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),F(P.prototype,"handleMouseEnterReferenceElement",[f],Object.getOwnPropertyDescriptor(P.prototype,"handleMouseEnterReferenceElement"),P.prototype),F(P.prototype,"handleMouseLeaveReferenceElement",[m],Object.getOwnPropertyDescriptor(P.prototype,"handleMouseLeaveReferenceElement"),P.prototype),F(P.prototype,"handleInsertTooltipper",[v],Object.getOwnPropertyDescriptor(P.prototype,"handleInsertTooltipper"),P.prototype),F(P.prototype,"handleUpdatedArguments",[g],Object.getOwnPropertyDescriptor(P.prototype,"handleUpdatedArguments"),P.prototype),F(P.prototype,"handleDestroyTooltipper",[b],Object.getOwnPropertyDescriptor(P.prototype,"handleDestroyTooltipper"),P.prototype),F(P.prototype,"handleInsertTooltip",[y],Object.getOwnPropertyDescriptor(P.prototype,"handleInsertTooltip"),P.prototype),F(P.prototype,"handleDestroyTooltip",[_],Object.getOwnPropertyDescriptor(P.prototype,"handleDestroyTooltip"),P.prototype),F(P.prototype,"handleMouseEnterTooltip",[E],Object.getOwnPropertyDescriptor(P.prototype,"handleMouseEnterTooltip"),P.prototype),F(P.prototype,"handleMouseLeaveTooltip",[w],Object.getOwnPropertyDescriptor(P.prototype,"handleMouseLeaveTooltip"),P.prototype),F(P.prototype,"hideTooltip",[O],Object.getOwnPropertyDescriptor(P.prototype,"hideTooltip"),P.prototype),F(P.prototype,"showTooltip",[T],Object.getOwnPropertyDescriptor(P.prototype,"showTooltip"),P.prototype),F(P.prototype,"toggleTooltip",[R],Object.getOwnPropertyDescriptor(P.prototype,"toggleTooltip"),P.prototype),F(P.prototype,"repositionTooltip",[C],Object.getOwnPropertyDescriptor(P.prototype,"repositionTooltip"),P.prototype),F(P.prototype,"_waitForAnimation",[n.waitFor],Object.getOwnPropertyDescriptor(P.prototype,"_waitForAnimation"),P.prototype),P)
...
"undefined"!=typeof document&&(r.p=(n=document.querySelectorAll("script"))[n.length-1].src.replace(/\/[^/]*$/,"/")),e.exports=(i=_eai_d,a=_eai_r,window.emberAutoImportDynamic=function(e){return 1===arguments.length?a("_eai_dyn_"+e):a("_eai_dynt_"+e)(Array.prototype.slice.call(arguments,1))},i("@zestia/animation-utils",[],(function(){return r(3)})),void i("@zestia/position-utils",[],(function(){return r(4)})))},function(e,t,r){"use strict"
function n(e,t){return new Promise((r=>{e.addEventListener("transitionend",(function n(i){e===i.target&&(t&&t!==i.propertyName||(e.removeEventListener("transitionend",n),r()))}))}))}function i(e,t){return new Promise((r=>{e.addEventListener("animationend",(function n(i){e===i.target&&(t&&t!==i.animationName||(e.removeEventListener("animationend",n),r()))}))}))}function a(){return new Promise(window.requestAnimationFrame)}r.r(t),r.d(t,"waitForTransition",(function(){return n})),r.d(t,"waitForAnimation",(function(){return i})),r.d(t,"waitForFrame",(function(){return a}))},function(e,t,r){"use strict"
function n(e){return[e.left+e.width/2,e.top+e.height/2]}function i(e,t,r,i){var a
return function(e,t){const r=n(e),[i,a]=r,s=[]
return a<t.top?s.push("top"):a>t.bottom?s.push("bottom"):s.push("middle"),i<t.left?s.push("left"):i>t.right?s.push("right"):s.push("center"),s.join(" ")}(e.getBoundingClientRect(),function(e,t,r){const n=e.width/t,i=e.height/r
return{left:e.left+n,top:e.top+i,right:e.right-n,bottom:e.bottom-i}}((a=t)instanceof Window?{top:0,left:0,right:a.innerWidth,bottom:a.innerHeight,width:a.innerWidth,height:a.innerHeight}:a instanceof Document?a.documentElement.getBoundingClientRect():a.getBoundingClientRect(),r,i))}function a(e,t,r){if(!t.offsetParent)return[0,0]
const i=t.getBoundingClientRect(),a=r.getBoundingClientRect(),s=t.offsetParent.getBoundingClientRect(),o=i.height,l=i.width,u=n(a),c=u[0]-l/2,d=u[1]-o/2,h=a.top,p=a.left,f=p+a.width,m=h+a.height,v=t.offsetParent.scrollTop,g=t.offsetParent.scrollLeft,b=-1*s.top,y=-1*s.left
let _,E
switch(e){case"top left":_=p,E=h-o
break
case"top center":_=c,E=h-o
break
case"top right":_=f-l,E=h-o
break
case"right top":_=f,E=h
break
case"right middle":_=f,E=d
break
case"right bottom":_=f,E=m-o
break
case"bottom left":_=p,E=m
break
case"bottom center":_=c,E=m
break
case"bottom right":_=f-l,E=m
break
case"left top":_=p-l,E=h
break
case"left middle":_=p-l,E=d
break
case"left bottom":_=p-l,E=m-o}return _+=y+g,E+=b+v,[_,E]}r.r(t),r.d(t,"getPosition",(function(){return i})),r.d(t,"getCoords",(function(){return a}))}])
