...
const A=(0,r.createTemplateFactory)({id:"AFU0Hw8j",block:'[[[11,1],[24,0,"__tooltip__"],[24,"hidden",""],[4,[38,0],[[30,0,["handleInsertElement"]]],null],[4,[38,1],[[30,0,["handleUpdatedArguments"]],[30,1],[30,2],[30,3],[30,4],[30,5]],null],[4,[38,2],[[30,0,["handleDestroyElement"]]],null],[12],[13],[41,[30,0,["shouldRenderTooltip"]],[[[44,[[50,"-tooltip",0,null,[["tooltip"],[[30,0]]]]],[[[41,[30,7],[[[40,[[[8,[30,6],[[17,8]],null,[["default"],[[[[18,9,[[30,0,["api"]]]]],[]]]]]],[]],"%cursor:0%",[28,[37,7],[[30,7]],null],null]],[]],[[[8,[30,6],[[17,8]],null,[["default"],[[[[18,9,[[30,0,["api"]]]]],[]]]]]],[]]]],[6]]]],[]],null]],["@columns","@element","@position","@rows","@show","Tooltip","@destination","&attrs","&default"],false,["did-insert","did-update","will-destroy","if","let","component","in-element","-in-el-null","yield"]]',moduleName:"@zestia/ember-async-tooltips/components/tooltip.hbs",isStrictMode:!1}),{max:C}=Math
let S=(m=(0,l.inject)("tooltip"),v=class extends n.default{constructor(){super(...arguments),P(this,"tooltipService",g,this),P(this,"isLoading",b,this),P(this,"loadedData",y,this),P(this,"loadError",_,this),P(this,"shouldRenderTooltip",w,this),P(this,"shouldShowTooltip",O,this),P(this,"tooltipCoords",E,this),P(this,"tooltipElement",T,this),P(this,"tooltipPosition",R,this),x(this,"hideTimer",null),x(this,"isLoaded",!1),x(this,"isOverTooltipElement",!1),x(this,"isOverTooltipperElement",!1),x(this,"loadDuration",0),x(this,"positionElement",null),x(this,"showTimer",null),x(this,"stickyTimer",null),x(this,"tetherID",null),x(this,"tooltipperElement",null),x(this,"willInsertTooltip",null)}get hasTooltip(){return!!this.tooltipElement}get canRenderTooltip(){return!this.isDestroyed&&this.needsToShowTooltip&&!this.childTooltip}get id(){return(0,o.guidFor)(this).replace("ember","")}get tooltipId(){return`tooltip-${this.id}`}get columns(){return this.args.columns??3}get rows(){return this.args.rows??3}get tooltipStyle(){const[e,t]=this.tooltipCoords
return(0,s.htmlSafe)(`top: ${t}px; left: ${e}px`)}get hideDelay(){return this.args.hideDelay??0}get showDelay(){return this.args.showDelay??0}get actualShowDelay(){return this.isSticky?0:this.isEager?C(this.showDelay-this.loadDuration,0):this.showDelay}get stickyTimeout(){return this.args.stickyTimeout??this.showDelay/2}get needsToShowTooltip(){return this.isOverTooltipperElement||this.isOverTooltipElement||this.args.show}get tooltips(){return this.tooltipService.tooltips.filter((e=>e!==this))}get childTooltip(){return this.tooltips.find((e=>this.tooltipperElement.contains(e.tooltipperElement)))}get parentTooltip(){return this.tooltips.find((e=>e.tooltipperElement.contains(this.tooltipperElement)))}get stickyTooltips(){return this.tooltipService.tooltips.filter((e=>e.args.stickyID===this.args.stickyID&&e.isSticky))}get shouldLoad(){return"function"==typeof this.args.onLoad&&!(this.isLoading||this.isLoaded)}get shouldLoadEagerly(){return this.isEager&&this.shouldLoad}get isEager(){return this.args.eager??!0}get isSticky(){return!0===this.tooltipService._sticky[this.args.stickyID]}get api(){return{data:this.loadedData,error:this.loadError,hide:this.hide}}handleInsertElement(e){this.element=e,this._update()}handleUpdatedArguments(){this._update()}handleInsertTooltip(e){this.tooltipElement=e,this.tooltipService._add(this),this._update(),this.willInsertTooltip.resolve()}handleDestroyTooltip(){this.tooltipElement=null,this.isOverTooltipElement=!1,this.shouldRenderTooltip=!1,this._updateTooltipper(),this.tooltipService._remove(this)}handleDestroyElement(){this._cancelTimers(),this._tearDown()}async handleMouseEnterTooltipperElement(){this.isOverTooltipperElement=!0,this.shouldLoadEagerly&&await this._load(),this._scheduleShowTooltip(),this.loadDuration=0}handleMouseLeaveTooltipperElement(){this.isOverTooltipperElement=!1,this._scheduleHideTooltip()}handleMouseEnterTooltip(){this.isOverTooltipElement=!0}handleMouseLeaveTooltip(){this.isOverTooltipElement=!1,this._scheduleHideTooltip()}hide(){return this._hideTooltip()}show(){this._showTooltip()}_handleManualToggling(){(0,i.next)((()=>this._maybeToggleViaArg()))}_maybeToggleViaArg(){!0===this.args.show?this._showTooltip():!1===this.args.show&&this._hideTooltip()}async _load(){const e=Date.now()
this.isLoading=!0,this._update()
...
this.loadDuration=t-e,this.isLoading=!1,this._update()}}_scheduleShowTooltip(){this._cancelTimers(),this.showTimer=(0,i.later)(this,"_attemptShowTooltip",this.actualShowDelay)}_attemptShowTooltip(){this.canRenderTooltip&&(this.parentTooltip&&this.parentTooltip.hide(),this._showTooltip())}async _showTooltip(){this.shouldShowTooltip=!0,this.shouldRenderTooltip||(this.shouldLoad&&this._load(),await this._renderTooltip(),await this._waitForAnimation(),this._handleShow())}_renderTooltip(){return this.willInsertTooltip=(0,u.defer)(),this.shouldRenderTooltip=!0,this.willInsertTooltip.promise}_scheduleHideTooltip(){this._cancelTimers(),this.hideTimer=(0,i.later)(this,"_attemptHideTooltip",this.hideDelay)}_attemptHideTooltip(){this.needsToShowTooltip||this._hideTooltip()}async _hideTooltip(){this.tooltipElement&&(this.shouldShowTooltip=!1,await this._waitForAnimation(),this._handleHide())}_cancelTimers(){(0,i.cancel)(this.showTimer),(0,i.cancel)(this.hideTimer),(0,i.cancel)(this.stickyTimer)}_scheduleResetSticky(){this.stickyTimer=(0,i.later)(this,"_attemptResetSticky",this.stickyTimeout)}_attemptResetSticky(){this.stickyTooltips.length||this.tooltipService._setSticky(this,!1)}_handleShow(){this.args.stickyID&&this.tooltipService._setSticky(this,!0),this._startTether(),this.args.onShow?.()}_handleHide(){this.args.stickyID&&this._scheduleResetSticky(),this._stopTether(),this._attemptDestroyTooltip(),this.args.onHide?.()}async _waitForAnimation(){await(0,h.waitForAnimation)(this.tooltipElement)}_attemptDestroyTooltip(){this.shouldShowTooltip||this._destroyTooltip()}_destroyTooltip(){this.shouldRenderTooltip=!1}_setUp(){this.tooltipperElement=this._getTooltipperElement(),this.positionElement=this._getPositionElement(),this.tooltipperElement.classList.add("tooltipper"),this._add("mouseenter",this.handleMouseEnterTooltipperElement),this._add("mouseleave",this.handleMouseLeaveTooltipperElement)}_update(){this.tooltipperElement&&this._tearDown(),this._setUp(),this._updateTooltipper(),this._handleManualToggling(),this._positionTooltip()}_updateTooltipper(){this.hasTooltip?this.tooltipperElement.setAttribute("aria-describedby",this.tooltipId):this.tooltipperElement.removeAttribute("aria-describedby"),this.isLoading?this.tooltipperElement.dataset.tooltipLoading="true":delete this.tooltipperElement.dataset.tooltipLoading}_tearDown(){this.tooltipperElement.classList.remove("tooltipper"),this._remove("mouseenter",this.handleMouseEnterTooltipperElement),this._remove("mouseleave",this.handleMouseLeaveTooltipperElement)}_add(){this.tooltipperElement.addEventListener(...arguments)}_remove(){this.tooltipperElement.removeEventListener(...arguments)}_getTooltipperElement(){return this._getElement(this.args.element)??this.element.parentElement}_getPositionElement(){return this._getElement(this.args.attachTo)??this.tooltipperElement}_getElement(e){return"string"==typeof e?document.querySelector(e):e instanceof HTMLElement?this.args.element:void 0}_tether(){this._positionTooltip(),this.tetherID=requestAnimationFrame(this._tether.bind(this))}_startTether(){requestAnimationFrame(this._tether.bind(this))}_stopTether(){cancelAnimationFrame(this.tetherID)}_getReferencePosition(){return(0,a.getPosition)(this.positionElement,window,this.columns,this.rows)}_computeTooltipCoords(){return(0,a.getCoords)(this.tooltipPosition,this.tooltipElement,this.positionElement)}_decideTooltipPosition(){const{position:e}=this.args
if("string"==typeof e)return e
const t=this._getReferencePosition()
return"function"==typeof e?e(t):(0,p.default)(t)}_positionTooltip(){this.hasTooltip&&(this.tooltipPosition=this._decideTooltipPosition(),this.tooltipCoords=this._computeTooltipCoords())}},g=k(v.prototype,"tooltipService",[m],{configurable:!0,enumerable:!0,writable:!0,initializer:null}),b=k(v.prototype,"isLoading",[c.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),y=k(v.prototype,"loadedData",[c.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),_=k(v.prototype,"loadError",[c.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),w=k(v.prototype,"shouldRenderTooltip",[c.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),O=k(v.prototype,"shouldShowTooltip",[c.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return!1}}),E=k(v.prototype,"tooltipCoords",[c.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return[0,0]}}),T=k(v.prototype,"tooltipElement",[c.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),R=k(v.prototype,"tooltipPosition",[c.tracked],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),k(v.prototype,"handleInsertElement",[f.action],Object.getOwnPropertyDescriptor(v.prototype,"handleInsertElement"),v.prototype),k(v.prototype,"handleUpdatedArguments",[f.action],Object.getOwnPropertyDescriptor(v.prototype,"handleUpdatedArguments"),v.prototype),k(v.prototype,"handleInsertTooltip",[f.action],Object.getOwnPropertyDescriptor(v.prototype,"handleInsertTooltip"),v.prototype),k(v.prototype,"handleDestroyTooltip",[f.action],Object.getOwnPropertyDescriptor(v.prototype,"handleDestroyTooltip"),v.prototype),k(v.prototype,"handleDestroyElement",[f.action],Object.getOwnPropertyDescriptor(v.prototype,"handleDestroyElement"),v.prototype),k(v.prototype,"handleMouseEnterTooltipperElement",[f.action],Object.getOwnPropertyDescriptor(v.prototype,"handleMouseEnterTooltipperElement"),v.prototype),k(v.prototype,"handleMouseLeaveTooltipperElement",[f.action],Object.getOwnPropertyDescriptor(v.prototype,"handleMouseLeaveTooltipperElement"),v.prototype),k(v.prototype,"handleMouseEnterTooltip",[f.action],Object.getOwnPropertyDescriptor(v.prototype,"handleMouseEnterTooltip"),v.prototype),k(v.prototype,"handleMouseLeaveTooltip",[f.action],Object.getOwnPropertyDescriptor(v.prototype,"handleMouseLeaveTooltip"),v.prototype),k(v.prototype,"hide",[f.action],Object.getOwnPropertyDescriptor(v.prototype,"hide"),v.prototype),k(v.prototype,"show",[f.action],Object.getOwnPropertyDescriptor(v.prototype,"show"),v.prototype),k(v.prototype,"_waitForAnimation",[d.waitFor],Object.getOwnPropertyDescriptor(v.prototype,"_waitForAnimation"),v.prototype),v)
e.default=S,(0,t.setComponentTemplate)(A,S)})),define("@zestia/ember-async-tooltips/services/tooltip",["exports","@ember/service","rsvp","@glimmer/tracking"],(function(e,t,r,n){"use strict"
var i,a
