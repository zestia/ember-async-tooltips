...
class TooltipComponent extends Component {
  static {
    g(this.prototype, "tooltipService", [service('tooltip')]);
  }
  #tooltipService = (i(this, "tooltipService"), void 0);
  static {
  ...
  static {
    g(this.prototype, "loadedData", [tracked], function () {
      return null;
    });
  }
  #loadedData = (i(this, "loadedData"), void 0);
  static {
    g(this.prototype, "loadError", [tracked], function () {
      return null;
    });
  }
  #loadError = (i(this, "loadError"), void 0);
  static {
    g(this.prototype, "shouldRenderTooltip", [tracked]);
  }
  #shouldRenderTooltip = (i(this, "shouldRenderTooltip"), void 0);
  static {
    g(this.prototype, "shouldShowTooltip", [tracked]);
  }
  #shouldShowTooltip = (i(this, "shouldShowTooltip"), void 0);
  static {
    g(this.prototype, "tooltipCoords", [tracked], function () {
      return [0, 0];
    });
  }
  #tooltipCoords = (i(this, "tooltipCoords"), void 0);
  static {
    g(this.prototype, "tooltipElement", [tracked]);
  }
  #tooltipElement = (i(this, "tooltipElement"), void 0);
  static {
    g(this.prototype, "tooltipPosition", [tracked]);
  }
  #tooltipPosition = (i(this, "tooltipPosition"), void 0);
  hideTimer;
  ...
  get canRenderTooltip() {
    return this.tooltipperElement && this.needsToShowTooltip && !this.childTooltip;
  }
  get needsToShowTooltip() {
    ...
    if (this.args.useFocus && (this.tooltipperElementIsFocused || this.tooltipElementIsFocused)) {
      return true;
    }
  ...
  get destinationElement() {
    return this.args.destination ? this.#getElement(this.args.destination) : this.element.parentElement;
  }
  get positionElement() {
    return this.args.popoverTarget ? this.#getElement(this.args.popoverTarget) : this.tooltipperElement;
  }
  get tooltipperElement() {
    return this.args.element ? this.#getElement(this.args.element) : this.element.parentElement;
  }
  ...
  handleFocusTooltipperElement = event => {
    this.tooltipperElementIsFocused = !this.tooltipperElement.dataset.programmaticallyFocused;
    this.#prepareToShowTooltip();
  };
  ...
  #hideFocusOnlyTooltip() {
    ...
    this.tooltipService.tooltips.find(tooltip => tooltip.tooltipperElement === document.activeElement && !tooltip.args.show)?.hide();
  }
  #cancelTimers() {
  ...
  static {
    n(this.prototype, "_waitForAnimation", [waitFor]);
  }
  ...
  #getTooltipCoords() {
    return getCoords(this.tooltipPosition, this.tooltipElement, this.positionElement);
  }
  #getTooltipPosition() {
    const {
      position
  ...
  position = modifier((_, [position, columns, rows, destination, popoverTarget]) => {
    this.#startTether();
  ...
  popover = modifier(() => {
    this.tooltipElement?.showPopover({
      source: this.positionElement
    });
    return () => this.tooltipElement?.hidePopover();
  });
  static {
    setComponentTemplate(precompileTemplate("<span class=\"__tooltip__\" hidden {{this.tooltipperEvents @element}} {{this.className}} {{this.visibility @show}} {{this.loading this.isLoading}}></span>\n{{~#if this.shouldRenderTooltip~}}\n  {{~#in-element this.destinationElement insertBefore=null~}}\n    <div class=\"tooltip\" data-showing=\"{{this.shouldShowTooltip}}\" data-position={{this.tooltipPosition}} data-sticky=\"{{this.isSticky}}\" id={{this.id}} style={{unless @usePopover this.tooltipStyle}} role=\"tooltip\" aria-live=\"polite\" popover={{if @usePopover \"manual\"}} {{this.register}} {{(if @usePopover this.popover)}} {{this.tooltipEvents}} {{this.aria}} {{this.position @position @columns @rows @destination @popoverTarget}} ...attributes>\n      {{~yield this.api~}}\n    </div>\n  {{~/in-element~}}\n{{/if}}", {
      strictMode: true
    }), this);
  }
}
